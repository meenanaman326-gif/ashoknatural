...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ashok Naturals — Pure Indian Spices" },
      { property: "og:description", content: "Premium natural spices and organic foods, sourced directly from Indian farms." },
